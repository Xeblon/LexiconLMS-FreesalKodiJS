...
namespace LexiconLMS.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Summary,Date,Time,ScheduleId")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Summary,Date,Time,ScheduleId")] Event @event)
        {
            if (ModelState.IsValid)
            {
